        ...
        <>
            ...
            <div className="principal_main_cont">
                ...
                <div className="principal_right_cont">
                    ...
                    <p>Welcome to Millenium Model School, a place where learning comes to life and dreams take flight!</p>
                    <p>As the proud principal of this remarkable institution, I am thrilled to welcome you to our vibrant community of learners. At Millenium Model School, we are committed to nurturing not only academic excellence but also personal growth, character development, and a strong sense of community.</p>
                    ...
                    <p>As we embark on another exciting academic year, I invite you to explore our website, learn more about our programs, faculty, and facilities, and become a part of the Millenium Model School family. Feel free to reach out with any questions or to schedule a visit. We look forward to partnering with you in creating a bright and promising future for our students.</p>
